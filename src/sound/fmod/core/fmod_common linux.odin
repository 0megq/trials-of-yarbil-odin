...
PRESET_CARPETTEDHALLWAY :: REVERB_PROPERTIES {
	300,
	2,
	30,
	5000,
...
SOUND_PCMREAD_CALLBACK :: #type proc "stdcall" (
	sound: ^SOUND,
	data: rawptr,
	datalen: u32,
) -> RESULT
...
FILE_ASYNCCANCEL_CALLBACK :: #type proc "stdcall" (
	info: ^ASYNCREADINFO,
	userdata: rawptr,
) -> RESULT
...
_3D_ROLLOFF_CALLBACK :: #type proc "stdcall" (
	channelcontrol: ^CHANNELCONTROL,
	distance: f32,
) -> f32
